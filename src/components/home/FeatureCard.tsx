...
export const FeatureCard = memo<FeatureCardProps>(({ icon, title, description, className }) => (
    <div className={`group relative p-8 rounded-2xl overflow-hidden bg-card border border-border transition-all duration-300 hover:shadow-lg hover:-translate-y-1 ${className}`}>
