...
/**
 * Drawing toolbar for CAD tools (Optimized with React.memo)
 */
export const DrawingToolbar = memo(() => {
    ...
    const tools = useMemo<{ id: CADTool; label: string; icon: React.ElementType; shortcut: string }[]>(() => [
    ...
    // Memoize tool click handler to prevent recreation
